    ...
    <div class="max-w-7xl mx-auto text-center animate-fade-in">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <div class="bg-orange-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 text-center">
                <img src="/images/estilista1.jpg" alt="Laura" class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
                <h4 class="text-xl font-semibold text-gray-800">Laura</h4>
                <p class="text-sm text-gray-600">experta en color y balayage</p>
            </div>

            {{-- estilista 2 --}}
            <div class="bg-orange-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 text-center">
                <img src="/images/estilista2.jpg" alt="Ana" class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
            ...
            {{-- estilista 3 --}}
            <div class="bg-orange-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 text-center">
                <img src="/images/estilista3.jpg" alt="Carlos" class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
